...
{ pkgs, ... }: {
  # FIX: Use the current stable channel (24.11)
  channel = "stable-24.11";

  packages = [
    pkgs.nodejs_22      # Use Node 22 (Current LTS)
    pkgs.firebase-tools
    pkgs.gh
  ];
