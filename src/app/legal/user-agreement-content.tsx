        ...
        <>
            ...
            <CardContent className="space-y-6 text-sm text-muted-foreground pt-4 max-h-[70vh] overflow-y-auto pr-6">
                ...
                <div className="space-y-2">
                 ...
                 <div className="space-y-2 p-4 border rounded-lg bg-secondary/50">
                  <h3 className="text-xl font-semibold text-foreground">AI Disclaimer and Limitation of Liability</h3>
                  <p>
                    You acknowledge that the Okidex app is produced with the assistance of artificial intelligence (AI). As such, you must be aware of the following:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
