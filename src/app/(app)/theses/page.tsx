...
export default function ThesesPage() {
  ...
  const handlePostThesis = async (e: React.FormEvent) => {
    ...
    const thesesCollectionRef = collection(db, 'theses');
    addDoc(thesesCollectionRef, newThesisData)
    .then(() => {
    ...
    .catch(async (serverError) => {
        const permissionError = new FirestorePermissionError({
            path: thesesCollectionRef.path,
            operation: 'create',
            requestResourceData: newThesisData,
        });
      ...
      <div className="flex flex-col items-center justify-center h-full text-center">
          <Card className="w-full max-w-md p-8">
              <CardHeader>
                  ...
                  <CardDescription>
                    {isFounder ? 
                      "This feature is available exclusively for Oki+ members. Upgrade your plan to view and respond to investors' theses." :
