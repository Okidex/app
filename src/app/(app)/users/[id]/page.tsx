...
import { getFinancialBreakdown } from "@/lib/client-actions";
import { notFound, useParams } from "next/navigation";
import UserAvatar from "@/components/shared/user-avatar";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Briefcase, Building, ExternalLink, Github, Linkedin, Mail, MapPin, User, Star, Pencil, Loader2, ShieldCheck, ShieldAlert, Lock, Link as LinkIcon, Twitter, HandCoins, BarChart2, Lightbulb, UserCheck } from "lucide-react";
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                         <a href={profile.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm text-primary hover:underline"><Linkedin className="w-4 h-4" /> <span>LinkedIn Profile</span></a>
