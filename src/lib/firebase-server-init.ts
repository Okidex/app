...
function getAdminApp(): admin.app.App | null {
  ...
  try {
    ...
    if (!serviceAccountString) {
      console.warn('[DEBUGGER-ADMIN] WARNING: FIREBASE_SERVICE_ACCOUNT environment variable not found. Server-side features will be limited.');
      return null;
    }
    ...
    try {
      ...
      console.log(`[DEBUGGER-ADMIN] SUCCESS: Parsed service account for project: ${serviceAccount.project_id}`);
