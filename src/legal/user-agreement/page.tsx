...
export default function UserAgreementContent() {
    return (
        <>
            <CardHeader>
                <CardTitle>Okidex User Agreement</CardTitle>
            ...
            <CardContent className="space-y-6 text-sm text-muted-foreground pt-4 max-h-[70vh] overflow-y-auto pr-6">
                <p>
                  Below is a summary of the key terms of the “Contract” that applies to your conduct during your use of our Services. When you use our Services you agree to our “User Agreement.” Your use of our Services is also subject to our Terms of Service as well as our Privacy Policy and Cookie Policy (which together cover how we collect, use, share, and store your personal data).
                </p>
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Key Obligations</h3>
                  <p>We can each end the Contract, but some rights and obligations will survive. Here are some key obligations that you agree to in the Contract:</p>
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>You will follow our “Dos and Don’ts” and our Investment Community Policies.</li>
                  </ul>
                </div>

                <div className="space-y-2 p-4 border rounded-lg bg-secondary/50">
                  <h4 className="text-lg font-semibold text-foreground">Investment Community Policies</h4>
                  <p>Our Investment Community Policies have three main elements:</p>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Your Responsibilities</h3>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Notices, Payments, and Liability</h3>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Acknowledgements About Our Services</h3>
                  <ul className="list-disc pl-6 space-y-2">
                 ...
                 <div className="space-y-2 p-4 border border-amber-300 dark:border-amber-700 rounded-lg bg-amber-50 dark:bg-amber-950/50">
                  <h3 className="text-xl font-semibold text-amber-900 dark:text-amber-300">AI Disclaimer and Limitation of Liability</h3>
                  <p className="text-amber-800 dark:text-amber-400">
                    You acknowledge that Okidex is an experimental application and is produced with the assistance of artificial intelligence (AI). As such, you must be aware of the following:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-amber-800 dark:text-amber-400">
                      <li><strong>No Guarantees of Accuracy:</strong> Information, matches, summaries, and other content generated by AI may contain inaccuracies, errors, or omissions. We make no guarantees regarding the accuracy, completeness, or reliability of any information provided through the Services.</li>
                      <li><strong>Not Financial Advice:</strong> Nothing you see on the Okidex platform constitutes professional, financial, legal, or investment advice. All content is for informational purposes only.</li>
                      <li><strong>Limitation of Liability:</strong> Okidex disclaims all liability for any errors or omissions in the data provided and for any decisions you make in reliance upon it. Your use of the information is at your own risk.</li>
                      <li><strong>User Discretion Required:</strong> You are solely responsible for your decisions. We strongly caution you to exercise your own discretion, conduct independent due diligence, and consult with qualified professionals before making any investment or business decisions.</li>
                  </ul>
                </div>

                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Okidex's Obligations</h3>
                  <ul className="list-disc pl-6 space-y-2">
